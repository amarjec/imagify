...
const Header = () => {
  ...
  return (
    ...
    >
        ...
        <motion.div 
        className='text-stone-500 inline-flex text-center gap-2 bg-white px-6 py-1 border border-neutral-500 rounded-full'
        ...
        className='flex items-center gap-2 rounded-full text-white bg-black sm:text-lg w-auto mt-8 px-12 py-2.5 cursor-pointer'
